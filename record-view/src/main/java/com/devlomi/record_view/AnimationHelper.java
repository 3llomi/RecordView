...
public class AnimationHelper {
    ...
    public void moveRecordButtonAndSlideToCancelBack(final RecordButton recordBtn, FrameLayout slideToCancelLayout, float initialX, float initialY, float difX) {
